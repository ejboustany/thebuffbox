...
import { Seo } from 'src/models/seo.model';
import { AccountService } from 'src/services/account.service';
import { SeoService } from 'src/services/canonical.service';
...
export class SinginComponent {
  ...
  private updateSeo(): void {
    this.seo.updateSeo(new Seo("Log in - PagePalooza",
      "Login, generate a website and host it for free.",
      "",
      "",
      new Array<string>("PagePalooza, Login, Signin")));
  }
}
